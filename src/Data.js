...
var SongOfSoaring = new Objective(2, "Song of Soaring", null, null, [BoatAccess], ["Ocarina of Time"], 0, 0, 0, 1, 4)
var SongOfAwakening = new Objective(3, "Song of Awakening", null, null, [BoatAccess], ["Ocarina of Time", "Deku Mask"], 0, 0, 180, 1, 2)
var OathToOrder = new Objective(4, "Oath To Order", null, null, [SwampCleared], null, 0, 0, 0, 1, 1)
...
var OcarinaOfTime = new Objective(11, "Ocarina of Time", null, null, [DeedQuestStarted], ["Magic"], 0, 0, 0, 0, 5)
...
var PowderKegLicence = new Objective(16, "Powder Keg Licence", null, null, [SpringTime], ["Goron Mask"], 0, 0, 30, 1, 2)
...
var GoldDustBottle = new Objective(22, "Gold Dust Bottle", null, null, [SpringTime], ["Fire Arrows"], 0, 0, 30, 1, 1)
...
var PriorityMailBottle = new Objective(25, "Priority Mail Bottle", "Night 3", null, [PriorityMailRecieved], ["Romani Mask"], 0, 0, 10, 1, 1)
...
var MaskOfScents = new Objective(35, "Mask of Scents", null, null, [SwampCleared], ["Bow"], 0, 0, 30, 1, 3)
...
var KeatonMask = new Objective(39, "Keaton Mask", "Day 3", "13:00-18:00", [PendantDelivered], ["Kafei's Mask"], 0, 0, 10, 1, 5)
var PostmansHat = new Objective(40, "Postman's Hat", "Night 3", null, [PriorityMailRecieved], null, 0, 0, 45, 1, 5)
var AllNightMask = new Objective(41, "All-Night Mask", "Night 3", "01:00-06:00", [GrandmaSaved], ["Giant's Wallet"], 0, 500, 10, 1, 2)
var RomaniMask = new Objective(42, "Romani Mask", "Night 2", "18:00", [RomaniFriended], ["Alien Bottle"], 0, 0, 60, 2, 1)
...
var CouplesMask = new Objective(45, "Couple's Mask", "Night 3", "04:30", [PendantDelivered, KafeiTrust], ["Hookshot", "Garo Mask"], 0, 0, 60, 2, 1)
...
var BombBagUpgrade1 = new Objective(56, "Bomb Bag Upgrade (Granny)", "Day 2 or Day 3 or Night 2 or Night 3", null, [GrandmaSaved], null, 0, 90, 10, 1, 4)
...
var PoHDekuPalaceLeftSide = new Objective(67, "PoH: Deku Palace Left Side", 0, 0, [BoatAccess], ["Ocarina of Time"], 0, 0, 15, 1, 3)
...
var PoHQMarks = new Objective(74, "PoH: ???", "Night", "00:00-06:00", [DeedQuestStarted], null, 0, 0, 5, 0, 1)
var PoHBuisnessScrubGrotto = new Objective(75, "PoH: Business Scrub Grotto", null, null, [DeedQuestStarted], ["Adult's Wallet"], 0, 100, 30, 1, 4, "Say no for the discount")
...
var PoHSwampDeed = new Objective(78, "PoH: Swamp Deed", null, null, [DeedQuestStarted], null, 0, 0, 10, 1, 4)
var PoHTinglePicture = new Objective(79, "PoH: Tingle Picture", null, null, [BoatAccess], ["Picto Box"], 0, 0, 20, 1, 2, "Cannot Complete if Swamp Saved")
...
var PoHKoumeGame = new Objective(82, "PoH: Koume's Game", null, null, [SwampCleared], ["Bow"], 0, 0, 45, 1, 2)
...
var PoHMountainDeed = new Objective(87, "PoH: Mountain Deed", null, null, [DeedQuestStarted], ["Bomb Bag", "Bow"], 0, 0, 20, 1, 4)
...
var PoHOceanDeed = new Objective(96, "PoH: Ocean Deed", null, null, [DeedQuestStarted], ["Zora Mask"], 0, 0, 10, 1, 2)
var PoHBeaverRace = new Objective(97, "PoH: Beaver Race", null, null, null, ["Hookshot"], 0, 0, 90, 1, 2)
var PoHSnowheadRoad = new Objective(98, "PoH: Snowhead Road", null, null, [ScarecrowSong], ["Hookshot"], 0, 0, 20, 1, 5)
var PoHPirateLagoon = new Objective(99, "PoH: PirateLagoon", null, null, [ScarecrowSong], ["Hookshot", "Song of Storms"], 0, 0, 30, 1, 4, "Need a Magic Bean")
...
var PoHIkanaDeed = new Objective(103, "PoH: Ikana Deed", null, null, [DeedQuestStarted], ["Hookshot", "Garo Mask"], 0, 0, 30, 1, 3)
var PoHCouplesMaskPeace = new Objective(104, "PoH: Couple's Mask Peace", null, null, null, ["Couple's Mask"], 0, 0, 15, 2, 4)
var PoHRoadToGoronVillageUnderwater = new Objective(105, "PoH: Road To Goron Village Underwater", null, null, [SpringTime], ["Zora Mask"], 0, 0, 25, 1, 1, "Do this before reset or with Don Gero")
var PoHDonGerosChoir = new Objective(106, "PoH: Don Gero's Choir", null, null, [SpringTime], ["Don Gero Mask", "Ice Arrows"], 0, 0, 180, 1, 2, "Do First Cycle if Possible")
var PoHFishermanIslandGame = new Objective(107, "PoH: Fisherman Island Game", null, null, [OceanCleared], ["Hookshot"], 0, 0, 45, 1, 2, "Find Boat NW of entrance to Great Bay")
